...
test_that("assertionsWork", {
  ...
  expect_error(assertthat::assert_that(is_env("")),
               "is not an environment")
  expect_error(assertthat::assert_that(is_list_of_df("")),
               "is not a list of data.frames")
  expect_error(assertthat::assert_that(is_url("")),
               "is not a url")
  expect_error(assertthat::assert_that(is_file("")),
               "is not a file")
  ...
  expect_error(assertthat::assert_that(contains_required("", "nothere")),
               "does not have one of")
  expect_error(assertthat::assert_that(app_dir_exists("")),
